...
Accountability_Corrupcion_y_violencia=merge(Corrupcion_y_violencia,VoiceandAccountability,by.x='Pais', by.y='Pais')
```
...
Gob_Ley=merge(Gobernabilidad,ImperiodelaLey,by.x='Pais', by.y='Pais')
```

```{r}
#MERGE DE LA VARIABLE GOBERNANZA - VARIABLES 1, 2, 3 Y 4

Gobernanza=merge(Accountability_Corrupcion_y_violencia,Gob_Ley, by.x='Pais', by.y='Pais')
```
