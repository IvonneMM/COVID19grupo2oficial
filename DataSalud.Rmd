...
```{r}
NumerodecamasHealthExpenditure = merge(Numerodecamas,HealthExpenditure)
UHCNumerodecamasHealthExpenditure = merge(UHC,NumerodecamasHealthExpenditure)
Doctores_EAUHCNumerodecamasHealthExpenditure = merge(Doctores_EA,UHCNumerodecamasHealthExpenditure)
DataSalud = merge(PBI_EA,Doctores_EAUHCNumerodecamasHealthExpenditure)
```
