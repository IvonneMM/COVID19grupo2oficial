...
```
#MERGE PARA QUEDARNOS CON LOS PAÍSES DE EUROPA Y AMÉRICA (Gonzalo Berger)
```{r}
...
```
```{r}
Modelo6=formula(Decesos~ UHC+CHE+CHE_percapita)
reg6cov=lm(Modelo6,data=Datacovidof2)
